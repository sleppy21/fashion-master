...
class SmoothTableUpdater {
    constructor() {
        ...
        this.fieldSelectorsTable = {
            ...
            codigo: 'td:nth-child(4) code',
            categoria: 'td:nth-child(5)',
            marca: 'td:nth-child(6)',
        ...
        this.fieldSelectorsGrid = {
            ...
            codigo: '.product-card-sku',
            categoria: '.product-card-category',
            marca: '.product-card-brand', // Añadido selector para marca
    ...
    detectChangedFields(productId, newData) {
        ...
        if (!cachedData) {
            ...
            return ['imagen', 'nombre', 'codigo', 'categoria', 'marca', 'precio', 'stock', 'estado'];
        }
        ...
        console.log('🔍 Comparando datos:', {
            productId,
            cached_codigo: cachedData.codigo,
            new_codigo: newData.codigo,
        ...
        if (cachedData.codigo !== newData.codigo) {
            console.log('✅ Código cambió:', cachedData.codigo, '→', newData.codigo);
            changed.push('codigo');
        }
