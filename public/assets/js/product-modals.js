...
if (typeof ProductModalManager === 'undefined') {
    console.log('✅ Declarando ProductModalManager (productos) por primera vez');
...
(function() {
    ...
    setInterval(hideAllScrollbars, 2000); // Cada 2 segundos
    
    // Ejecutar después de delays iniciales
    setTimeout(hideAllScrollbars, 100);
    setTimeout(hideAllScrollbars, 500);
    setTimeout(hideAllScrollbars, 1000);
    setTimeout(hideAllScrollbars, 2000);
